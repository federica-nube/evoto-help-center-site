---
title: "Tùy chỉnh chất lượng xuất ảnh trong Evoto: Hướng dẫn các cài đặt nâng cao"
source_url: "https://support.evoto.ai/vi/tuy-chinh-chat-luong-xuat-anh-trong-evoto-huong-dan-cac-cai-dat-nang-cao/"
source_type: "post"
source_id: "11244"
language: "vi"
...
- **Mặc định**: Xuất ảnh của bạn ở định dạng mặc định, được tối ưu cho mục đích sử dụng chung.
- **JPG**: Phù hợp cho những ảnh cần tiết kiệm dung lượng ảnh và sử dụng định dạng nén.
- **TIFF (8 bit / 16 bit)**: Phù hợp nhất cho ảnh chất lượng cao, không nén, đặc biệt khi bạn có kế hoạch chỉnh sửa thêm hoặc cần độ sâu màu cao hơn.
...
- **Điều chỉnh theo phần trăm**: Thay vì cài đặt chất lượng với 14 mức trước đây, giờ đây bạn có thể thiết lập chất lượng xuất ảnh theo phần trăm. Điều này giúp bạn kiểm soát chính xác hơn chất lượng hình ảnh sau khi xuất.
- **Ngưỡng chất lượng tối thiểu**: Nếu bạn đặt phần trăm quá thấp, Evoto vẫn sẽ xuất ảnh với chất lượng tối thiểu 20% để đảm bảo hình ảnh vẫn có thể sử dụng được.

Các **cài đặt nâng cao** của Evoto khi xuất ảnh mang lại cho bạn sự linh hoạt để điều chỉnh định dạng, chất lượng và kích thước ảnh theo nhu cầu. Dù bạn cần một ảnh TIFF chất lượng cao để in ấn hay một ảnh JPG được nén để sử dụng trực tuyến, những cài đặt này giúp bạn đạt được sự cân bằng tối ưu giữa chất lượng và kích thước ảnh. Hãy nhớ rằng hệ thống được thiết kế để bảo vệ chất lượng hình ảnh, đảm bảo rằng ngay cả khi cài đặt ở mức thấp hơn, hình ảnh của bạn vẫn giữ được độ chi tiết và rõ nét hợp lý.
