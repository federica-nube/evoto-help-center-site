...
source_url: "https://support.evoto.ai/vi/cai-dat-tai-khoan/"
source_type: "post"
source_id: "4436"
language: "vi"
...
1. Sau khi đăng nhập, nhấp vào ảnh đại diện có chữ cái đầu trong tên của bạn ở góc trên bên phải của giao diện. Sau đó nhấp vào “Cài đặt tài khoản”.
2. Chọn “Đổi mật khẩu” trong phần Thông tin cơ bản. Nhấp vào đó và một mã xác minh sẽ được gửi đến email hoặc điện thoại của bạn.
3. Nhập mã xác minh, sau đó đặt mật khẩu mới và nhập lại mật khẩu để xác nhận.

**Trên trang web chính thức của Evoto**

1. Vào “Trung tâm bảo mật” trong cài đặt tài khoản của bạn.
2. Chọn "Đổi mật khẩu" trong phần Cài đặt tài khoản.
...
Sau đây là các bước để thay đổi địa chỉ email của bạn:

1. Đăng nhập vào trang web chính thức của Evoto.
2. Nhấp vào ảnh đại diện của bạn và chọn “Tài khoản của tôi” và đi đến “Trung tâm bảo mật”.
3. Nhấp vào “Thay đổi email”.
4. Kiểm tra mã xác minh được gửi đến email hiện tại của bạn.
5. Nhập mã xác minh rồi nhập địa chỉ email mới của bạn.
...
Công cụ đo độ mạnh của mật khẩu: Sử dụng các chỉ báo tích hợp để đảm bảo mật khẩu của bạn đáp ứng các tiêu chuẩn bảo mật.
...
Để xóa trạng thái đăng nhập, vui lòng vào mục “Thiết bị”, sau đó nhấp vào “Gỡ” để đăng xuất thiết bị. Bạn vẫn có thể đăng nhập lại trên các thiết bị đó sau khi đăng xuất.
