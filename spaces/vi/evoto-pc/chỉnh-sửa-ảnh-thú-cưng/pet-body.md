---
title: "Cơ thể"
source_url: "https://support.evoto.ai/vi/pet-body/"
source_type: "post"
source_id: "21688"
language: "vi"
...
Tính năng xóa dây dắt thú cưng cho phép tự động nhận diện và xóa bỏ dây dắt thú trong ảnh thú cưng trong khi vẫn giữ được kết cấu và chi tiết phông nền của ảnh gốc.

Nhấp vào nút **"Áp dụng"** và AI sẽ tự động nhận diện và xóa dây dắt khỏi ảnh thú cưng của bạn.

Công cụ này sẽ tạo ra một tệp mới định dạng **.tsq** và tiêu tốn **1 ảnh** khi bạn xuất phiên bản ảnh mới được tạo. Ảnh mới vẫn giữ nguyên tất cả các chỉnh sửa đã áp dụng trước đó. Để tìm các ảnh đã được tạo, hãy sử dụng bộ lọc trong thư viện và chọn **“Khác”**.

**Lưu ý:**

- Chỉ hỗ trợ xử lý một ảnh đơn lẻ (không hỗ trợ xử lý hàng loạt).
...
Điều chỉnh thanh trượt để kiểm soát cường độ hiệu ứng:

- **0**: Không áp dụng hiệu ứng
