---
title: "Ảnh Evoto"
source_url: "https://support.evoto.ai/vi/anh-evoto/"
source_type: "post"
source_id: "9917"
language: "vi"
translation_group: "1075"
primary_category: "gia-ca-thanh-toan"
...
source_assets:
  ...
  - "https://support.evoto.ai/wp-content/uploads/2025/04/screenshot-20250725-162211-scaled.png"
...
- Nếu cùng một ảnh nhưng được nhập từ **một thiết bị khác**, Evoto sẽ coi đó là một tệp mới và bạn sẽ bị trừ thêm ảnh khi xuất lại ảnh.
...
1. Nhấp vào biểu tượng thẻ quà tặng (????) ở góc trên bên phải của ứng dụng.
2. Chọn mục “Hãy cho chúng tôi biết về bạn”.
3. Điền đầy đủ thông tin vào mẫu và gửi đi — 15 ảnh sẽ được tự động cộng vào tài khoản của bạn.

> Lưu ý: Mỗi thiết bị chỉ có thể nhận thưởng một lần duy nhất. Số ảnh thưởng được cộng chỉ có giá trị trong vòng 30 ngày, kể từ ngày nhận thưởng.
...
- Vào Tài khoản của tôi → **Thanh toán và sử dụng → Thanh toán và sử dụng** để xem chi tiết số ảnh còn khả dụng và lịch sử sử dụng ảnh.
...
Để kiểm tra thời hạn sử dụng của gói ảnh:

1. Đăng nhập vào [evoto.ai](https://www.evoto.ai/vi)
2. Vào **Tài khoản của tôi → Thanh toán và sử dụng → Gói có sẵn & Gói hết hiệu lực**

- **Gói có sẵn:** Hiển thị các gói ảnh đang có và số ảnh khả dụng, kèm theo ngày hết hạn của từng gói.
- **Gói hết hiệu lực**: Các gói đã sử dụng hết hoặc đã hết hạn. Kéo xuống để xem lịch sử của tất cả các gói trước đây.
...
- **Đối với gói ảnh dành cho doanh nghiệp**: Để sử dụng cho nhiều thiết bị và thiết lập tài khoản quản trị viên, vui lòng liên hệ với Người quản lý tài khoản của bạn.
