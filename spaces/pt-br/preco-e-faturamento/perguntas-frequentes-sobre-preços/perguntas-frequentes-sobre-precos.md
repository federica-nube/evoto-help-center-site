...
source_url: "https://support.evoto.ai/pt-br/perguntas-frequentes-sobre-precos/"
source_type: "post"
source_id: "23616"
language: "pt-br"
...
Esta seção responde às dúvidas mais comuns sobre preços do Evoto, tipos de planos, pagamentos e políticas relacionadas.
...
- **Plano Pague Conforme o Uso:**
  - **Ideal para:** Uso ocasional ou imprevisível.
  - **Vantagens:** Máxima flexibilidade, sem compromisso recorrente.
- **Plano de Assinatura Anual:**
  - **Ideal para:** Usuários consistentes e de alto volume.
  - **Vantagens:** Menor custo por crédito, acúmulo (rollover) de créditos não utilizados e acesso a Pacotes Adicionais (Add-on Packs) exclusivos.
- **Recomendações:**
...
- Durante o período ativo da assinatura, não é possível comprar créditos Pague Conforme o Uso.
- Se precisar de mais créditos antes do próximo ciclo de cobrança, adquira um Pacote Adicional, que utiliza a mesma taxa por crédito do seu plano de assinatura.
- Após o término ou cancelamento da assinatura, você poderá voltar a comprar pacotes Pague Conforme o Uso.

> Observação: Créditos de assinatura não utilizados (incluindo créditos acumulados) podem ser perdidos caso a assinatura não seja renovada.
...
- No entanto, fique à vontade para entrar em contato pelo e-mail support@evoto.ai para obter mais informações ou consultar sobre possíveis programas futuros.
...
- Recomendamos revisar nossa **Política de Reembolso oficial** no site para obter informações completas.
- Você também pode entrar em contato com support@evoto.ai para dúvidas específicas.
...
1. Use outro cartão de crédito ou método de pagamento.
2. Aguarde **24 horas** antes de tentar novamente. Tentativas repetidas em curto período podem prolongar o bloqueio.
3. Entre em contato com seu banco para:
  - Ativar transações internacionais, se aplicável.
  - Remover possíveis bloqueios de segurança ou limites de gasto.

- **Causas comuns incluem:** saldo insuficiente, bloqueios antifraude, cartão expirado, restrições para compras internacionais ou falhas técnicas temporárias.
...
- **Verificar sua conexão com a internet:** confirme se está estável acessando outros sites ou aplicativos.
- **Verificar o uso de VPN:** algumas VPNs podem interferir no carregamento de pagamentos. Tente desativá-la temporariamente.
- **Usar outro navegador ou dispositivo:** problemas de compatibilidade ou cache podem afetar o processo.

Se ainda assim o problema continuar, entre em contato com **support@evoto.ai** para obter ajuda adicional.
