---
title: "Perguntas Frequentes sobre Conta"
source_url: "https://support.evoto.ai/pt-br/perguntas-frequentes-sobre-conta/"
source_type: "post"
source_id: "23272"
language: "pt-br"
...
- Fazer login no aplicativo Evoto em todos os dispositivos compatíveis (desktop e iPad).
- Gerenciar créditos, planos de assinatura e configurações de cobrança de forma prática.
- Acessar presets na nuvem e configurações personalizadas, garantindo consistência em todo o seu fluxo de trabalho.
- Receber atualizações importantes, anúncios de novos recursos e suporte dedicado da nossa equipe.
...
**Inscreve-se pelo aplicativo Evoto**

1. Baixe e instale o aplicativo Evoto na loja de aplicativos do seu dispositivo.
2. Abra o aplicativo e localize a opção **Inscrever-se** na tela de login.
3. Insira seu **endereço de e-mail** ou **número de telefone** para criar sua conta.
...
- Para informações gerais sobre como começar, consulte nosso Guia de Início.
...
1. Vá em **Configurações→ Ver todas as configurações → Filtros e Endereços Bloqueados**.
2. Clique em **Criar um novo filtro**.
3. No campo **“De”**, insira todos os endereços noreply da Evoto, separados por vírgulas (ex.: noreply@mail.evoto.ai, noreply@mail1.evoto.ai, …).
4. Clique em **Criar filtro**.
5. Marque a opção **“Nunca enviar para Spam”** e finalize o filtro.

**Outlook / Hotmail**

1. Vá em **Configurações → Ver todas as configurações do Outlook → Email → Email Indesejado**.
2. Em **Remetentes e domínios confiáveis**, clique em **+ Adicionar** e insira cada um dos endereços noreply da Evoto individualmente.
3. Clique em **Salvar**.

**Yahoo Mail**

1. Vá em **Configurações → Mais Configurações → Filtros**.
2. Clique em **Adicionar novo filtro**.
...
1. Na tela de login, clique no link “**Esqueceu a senha?**” ou “**Redefinir senha**”.
2. Insira o endereço de e-mail ou número de telefone registrado.
3. Siga as instruções enviadas para seu e-mail ou telefone para criar uma nova senha.
