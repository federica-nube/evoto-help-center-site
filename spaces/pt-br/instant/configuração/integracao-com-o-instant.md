---
title: "Integração com o Instant"
source_url: "https://support.evoto.ai/pt-br/integracao-com-o-instant/"
source_type: "post"
source_id: "24781"
language: "pt-br"
...
Bem-vindo ao **Evoto Instant** — sua ferramenta completa de fluxo de trabalho de imagem que leva você da captura à entrega em segundos. Com disparo automatizado, seleção inteligente com IA (AI culling), retoque com IA e compartilhamento instantâneo, o Evoto Instant ajuda você a trabalhar de forma mais eficiente e a entregar resultados profissionais com mais rapidez. Este guia apresenta o fluxo de trabalho completo para que você entenda como as fotos passam da captura à entrega e como a IA do Evoto auxilia em cada etapa do processo.
...
- Se você ainda não tiver uma conta, pode se cadastrar diretamente no aplicativo.
- Sua **Conta Evoto** funciona em todos os produtos — Evoto Desktop, Evoto iPad e Evoto Instant — e seus **Créditos Evoto** são compartilhados entre eles.

Após fazer login, você será direcionado para a página inicial — o centro de controle onde todos os seus projetos ficam organizados. A partir daí, você pode criar novos projetos, ajustar fluxos de trabalho e acessar galerias.

Você também pode acessar pelo [portal web do Evoto Instant](https://workspace.instant.evoto.ai/pt-br/list), que permite pré-configurar as configurações do projeto, enquanto o aplicativo móvel funciona como ferramenta de captura e importação.
...
Ao criar um novo projeto, você pode:

- Nomear seu projeto (por exemplo, “Casamento Johnson 2025” ou “Campanha de Marca – T3”).
- Adicionar uma data ou período opcional.
- Ativar ou desativar a **Seleção Inteligente com IA (AI culling)** e a **Edição com IA**, conforme sua necessidade.
- Escolher as configurações de exportação: **exportação manual** para controle total ou **exportação automática** para entrega em tempo real.
- Personalizar o espaço do projeto com banners ou marcas d’água da sua marca.
...
O checklist exibe **4**tarefas obrigatórias de configuração:

- Inserir nome e data
- Definir configurações personalizadas de marca
- Escolher um efeito de edição com IA
- Acessar as configurações de compartilhamento

**Observações:**

- O checklist aparece automaticamente quando um novo projeto é criado.
- Ele pode ser recolhido manualmente e minimizado para o canto inferior direito da interface. Se necessário, você pode clicar no ícone do checklist a qualquer momento para reabri-lo.
- Se você já estiver familiarizado com o fluxo de criação de projetos, pode selecionar **“Não mostrar novamente”** para desativar a exibição automática. Caso precise, basta clicar no ícone do checklist para acessá-lo novamente.
