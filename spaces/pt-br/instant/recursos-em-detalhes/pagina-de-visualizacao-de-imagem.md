---
title: "Página de Visualização de Imagem"
source_url: "https://support.evoto.ai/pt-br/pagina-de-visualizacao-de-imagem/"
source_type: "post"
source_id: "25287"
language: "pt-br"
...
A página de visualização de imagem é onde pode rever fotos individuais em detalhe, aceder ao estado de edição, comparar efeitos de IA e gerir operações ao nível da imagem.

Basta tocar em qualquer foto do seu projeto para abrir a vista de visualização.
...
- Se um rosto já tiver sido compartilhado, será apresentado com uma marca de verificação.
- Se ainda não tiver sido compartilhado, pode atribuir e compartilhar esse rosto diretamente a partir desta vista.

**Nota:** A funcionalidade **'Interagir (Interact)'**deve estar ativada no projeto para que o Reconhecimento Facial esteja disponível.
