...
source_url: "https://support.evoto.ai/pt-br/perguntas-frequentes-sobre-importacao-e-exportacao/"
source_type: "post"
source_id: "23842"
language: "pt-br"
...
Para melhorar a qualidade da visualização:

1. Acesse **Configurações → Visualização → Tamanho da visualização**.
2. Embora o Evoto selecione automaticamente um valor padrão, você pode aumentar o tamanho da visualização para até 4000 px, que é a resolução máxima atualmente suportada.
3. Essa configuração afeta apenas a exibição da imagem dentro do Evoto e não altera a qualidade final da exportação.
