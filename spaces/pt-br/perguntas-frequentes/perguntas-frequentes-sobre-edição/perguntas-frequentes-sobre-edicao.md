---
title: "Perguntas Frequentes sobre Edição"
source_url: "https://support.evoto.ai/pt-br/perguntas-frequentes-sobre-edicao/"
source_type: "post"
source_id: "23667"
language: "pt-br"
...
migration_flags:
  - "image"
source_assets:
  - "https://support.evoto.ai/wp-content/uploads/2026/01/7-300x249.jpg"
...
Como alterar o tamanho da visualização:

1. Acesse o **menu do Evoto** no canto superior esquerdo da tela.
2. Selecione **Configurações**.
3. Clique na aba **Visualização** na janela de configurações.
4. Ajuste o tamanho da visualização conforme necessário, até o máximo de **4000 px**.
5. Clique em **OK** para salvar as alterações.

![](https://support.evoto.ai/wp-content/uploads/2026/01/7-300x249.jpg)

> Observação: Um tamanho de visualização maior pode causar desempenho mais lento do computador.
...
- **Recomendação:** Embora não exista uma sequência obrigatória de edição, recomendamos fazer primeiro os ajustes de cor e, depois, o retoque base. Esse fluxo geralmente previne conflitos de efeitos e oferece uma base melhor para seus ajustes detalhados.
