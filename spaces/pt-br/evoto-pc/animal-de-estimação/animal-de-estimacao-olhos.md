---
title: "Animal de Estimação - Olhos"
source_url: "https://support.evoto.ai/pt-br/animal-de-estimacao-olhos/"
source_type: "post"
source_id: "21675"
language: "pt-br"
...
Ajuste o controle deslizante (slider) para controlar o nível de brilho dos olhos do seu animal de estimação.

> Observação: Você pode desbloquear o ícone de vincular para ajustar os olhos esquerdo e direito separadamente, permitindo um controle mais preciso.
...
Ajuste o controle deslizante para controlar a intensidade da cor.
...
> Observação: Suporta processamento em lote e sincronização de ajustes em múltiplas imagens.

- **Valor** – controla a opacidade e o brilho do reflexo.
- **Horizontal** – move o reflexo para a esquerda ou direita dentro do olho.
- **Vertical** – move o reflexo para cima ou para baixo dentro do olho.
- **Girar** – altera a rotação ou o ângulo da forma do reflexo.
