...
source_url: "https://support.evoto.ai/pt-br/laboratorio-de-ia/"
source_type: "post"
source_id: "25146"
language: "pt-br"
translation_group: "8141"
primary_category: "sem-categoria"
migration_flags:
  - "image"
  - "possible_shortcode"
source_assets:
  - "https://support.evoto.ai/wp-content/uploads/2026/02/6-300x154.jpg"
  ...
  - "https://support.evoto.ai/wp-content/uploads/2026/02/10-300x211.jpg"
---

# **Laboratório de IA**

**Como acessar:** Clique no ícone**Laboratório de IA** no canto superior esquerdo da interface **Editar**.
...
**Aplicar Efeito:**Clique em**Gerar** para aplicar. Cada aplicação consome **0,3 créditos**.
...
**Aplicar Efeito:**Clique em **Remover** para executar. Cada aplicação consome os créditos correspondentes. **Opções de Salvamento** Escolha como deseja aplicar os efeitos após usar o **Lab de IA** e retornar à interface **Editar**. **Aplicar na Imagem Atual (Manter uma cópia da imagem):** O efeito será aplicado diretamente à foto atual na interface de edição. O arquivo original não será modificado. **Gerar Cópia (Criar uma nova cópia):** Uma nova cópia com o efeito aplicado será criada. Você pode alterar o local de armazenamento das cópias geradas em Configurações. ![](https://support.evoto.ai/wp-content/uploads/2026/02/10-300x211.jpg)
