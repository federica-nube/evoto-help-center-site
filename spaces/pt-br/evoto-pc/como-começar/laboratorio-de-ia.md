...
**Aplicar Efeito:**Clique em **Remover** para executar. Cada aplicação consome os créditos correspondentes. **Opções de Salvamento** Escolha como deseja aplicar os efeitos após usar o **Lab de IA** e retornar à interface **Editar**. **Aplicar na Imagem Atual (Manter uma cópia da imagem):** O efeito será aplicado diretamente à foto atual na interface de edição. O arquivo original não será modificado. **Gerar Cópia (Criar uma nova cópia):** Uma nova cópia com o efeito aplicado será criada. Você pode alterar o local de armazenamento das cópias geradas em Configurações.
