---
title: "Como Alcançar a Retoque de Pele para Resultados Naturais"
source_url: "https://support.evoto.ai/pt-br/como-alcancar-a-retoque-de-pele-para-resultados-naturais/"
source_type: "post"
source_id: "24311"
language: "pt-br"
...
O conjunto de ferramentas de Retoque de Pele do Evoto oferece recursos avançados para refinar os detalhes da pele e alcançar resultados naturais e profissionais. Ao compreender a função de cada ferramenta, você pode realizar ajustes sutis ou transformações mais marcantes, sempre mantendo um acabamento equilibrado e realista.
...
- **Uniformizar (Dodge & Burn):**Esta ferramenta clareia e escurece automaticamente áreas específicas do rosto, ajudando a suavizar rugas, reduzir imperfeições e corrigir tons irregulares. O resultado é uma pele limpa e natural, adequada para diferentes tipos de pele.
- **Esculpir (Dodge & Burn):**Refina a iluminação e a definição dos contornos para realçar a dimensionalidade do rosto. Inclui dois controles ajustáveis:
  - **Slider de Traços Faciais:** Realça áreas como olhos, lábios e nariz, aumentando profundidade e definição.
...
- **Suavização de Pele Facial:** Suaviza a pele do rosto atuando principalmente na **camada de baixa frequência (tom e cor)**, enquanto preserva os detalhes da **camada de alta frequência (textura)**. Ajuste o controle com cuidado para manter um resultado natural e evitar um efeito excessivamente artificial.
...
- **Brilho:**Ajusta o brilho dos realces existentes na pele, permitindo intensificar ou reduzir a reflexão da luz.
...
**Predefinição Satin:** Reduz o brilho para um resultado suave e natural.

**Predefinição Matte:**Ajusta brilho, textura e nitidez para criar uma aparência refinada e com menos reflexão.

**Predefinição Dewy:**Aumenta o brilho, proporcionando um acabamento radiante e luminoso à pele.
...
- **Tom de Pele**: Escolha entre 8 tons predefinidos e ajuste com o slider.
- **Temperatura**: Aquece ou resfria o tom de pele selecionado.
- **Tom**: Ajusta a vermelhidão da pele. Ideal para corrigir tons excessivamente avermelhados.
...
- **Caneta de Ajuste Manual**Permite aplicar ou remover manualmente efeitos de suavização em áreas específicas. Use esta ferramenta para preservar a textura natural onde necessário ou para corrigir imperfeições individualmente.
- **Ajustes com Máscaras Locais**Para um controle ainda mais preciso, utilize **Máscaras Locais > Ajustes de Cor** para refinar manualmente o tom da pele numa área específica. Essa ferramenta permite ajustes de cor direcionados em pele do rosto, corpo pu toda a pele.

Compreendendo o propósito de cada ferramenta e como combiná-las, você pode obter resultados profissionais e naturais na pele de seus retratos.
