---
title: "Como Obter um Fundo Limpo no Evoto"
source_url: "https://support.evoto.ai/pt-br/como-obter-um-fundo-limpo-no-evoto/"
source_type: "post"
source_id: "24434"
language: "pt-br"
translation_group: "6695"
...
A seguir, vamos apresentar as principais ferramentas passo a passo.
...
2. Ative a função.
3. O Evoto detectará automaticamente elementos como tripés de iluminação, cabos ou outros objetos do estúdio e os removerá.
4. Se sua foto não for processada automaticamente, use o **menu suspenso** e selecione **Distrações** para garantir que a IA trate a imagem como uma foto com fundo sólido.
...
1. Mude para a opção **Limpar Fundo** e ative-a.
2. Use o **slider Plano de Fundo e Chão** para ajustar a suavidade geral do fundo.
3. Para ajustes mais detalhados, utilize os **sub-sliders Plano de Fundo & Chão** separadamente. Por exemplo, você pode deixar a parede perfeitamente limpa enquanto mantém alguma textura natural no chão.
...
Ajuste os dois sliders:

- **Valor**: controla a intensidade da aplicação do efeito.
- **Luminosidade**: ajuda a equilibrar os níveis de brilho. Isso é especialmente útil se a iluminação do estúdio tiver deixado pontos mais claros ou sombras pelo fundo.
...
- Após esta etapa, seu fundo deverá ficar totalmente uniforme e limpo, sem transições de cor que distraiam.
