---
title: "iPad – Espaço de Trabalho do Projeto"
source_url: "https://support.evoto.ai/pt-br/ipad-espaco-de-trabalho-do-projeto/"
source_type: "post"
source_id: "22619"
language: "pt-br"
...
O Evoto para iPad oferece quatro opções de importação de imagens:

- **Arquivos:** importe diretamente do sistema de arquivos do iPad.
- **Fotos:** selecione imagens da sua biblioteca de fotos.
- **Captura Conectada:** capture imagens diretamente de uma câmera compatível.
- **Compartilhado por Outros Apps:** importe imagens compartilhadas a partir do Lightroom, Capture One ou aplicativos semelhantes.
...
- Toque no botão “…” no canto inferior direito do cartão do projeto para renomeá-lo ou excluí-lo.
- Toque em qualquer projeto para abrir**o espaço de ajustes finos** e continuar editando ou revisando as imagens.
...
- **Importar Imagens:** selecione imagens diretamente do armazenamento local do iPad. Um novo projeto será criado automaticamente, a predefinição correspondente ao módulo será aplicada a todas as imagens importadas e o painel lateral direito focará automaticamente no grupo de recursos relevante para edição imediata.
- **Escolher Imagens de Demonstração:** cada módulo inclui de 2 a 3 imagens de demonstração cuidadosamente selecionadas para mostrar suas funcionalidades. Ao tocar em uma imagem de demonstração, um novo projeto será criado automaticamente, todas as imagens demo serão importadas e a predefinição correspondente será aplicada, permitindo uma visualização instantânea das capacidades do módulo.
...
- Ao selecionar um tutorial, o navegador será aberto automaticamente para reproduzir o vídeo no YouTube.
...
Você pode abrir uma janela pop-up com artigos relevantes clicando no ícone **?**, disponível em dois locais:

- No canto inferior esquerdo do espaço de trabalho do projeto.
