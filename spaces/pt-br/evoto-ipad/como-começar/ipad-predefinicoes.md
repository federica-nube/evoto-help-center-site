---
title: "Ipad - Predefinições"
source_url: "https://support.evoto.ai/pt-br/ipad-predefinicoes/"
source_type: "post"
source_id: "22503"
language: "pt-br"
...
migration_flags:
  ...
  - "possible_shortcode"
source_assets:
  - "https://support.evoto.ai/wp-content/uploads/2025/12/8-300x209.jpg"
...
1. Toque no botão **Salvar Predefinição** localizado no canto inferior direito.
2. Insira um nome para a predefinição.
3. Selecione a categoria apropriada da predefinição.
4. Escolha quais efeitos incluir na predefinição.
5. Toque em **Salvar** para concluir o processo.
...
- **Padrão** – Salva todas as configurações de efeitos padrão.
- **Ajustado**– Salva apenas os sliders ou ajustes que você modificou.

Isso permite um controle preciso sobre o que cada predefinição contém.
