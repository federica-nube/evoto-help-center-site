---
title: "Biblioteca"
source_url: "https://support.evoto.ai/es/library-es/"
source_type: "post"
source_id: "3126"
language: "es"
...
source_assets:
  ...
  - "https://support.evoto.ai/wp-content/uploads/2025/04/20250916212631-scaled.jpg"
...
- **Vista de biblioteca:** muestra botones adicionales para Deshacer, Crear proyectos, importar archivos y buscar proyectos.

![](https://support.evoto.ai/wp-content/uploads/2025/04/Screenshot-2025-07-08-at-20.49.51-300x41.png)

- **Vista de edición:** muestra botones para Deshacer, Herramientas manuales y una barra de búsqueda para las funciones disponibles.
...
- **Papelera**: Contiene las imágenes eliminadas. Puedes restaurarlas o eliminarlas permanentemente.

El panel izquierdo se puede redimensionar para ajustar la disposición del espacio de trabajo según la preferencia del usuario.
...
- **Papelera:** contiene imágenes eliminadas. Puedes restaurarlas o eliminarlas permanentemente.
...
- **Filtrado:** Filtra por calificación con estrellas, etiqueta de color, marca, estado de edición, estado de exportación, formato, relación de aspecto, nombre de archivo, cámara y lente de cámara. Usa el lado derecho de la tira de imágenes para aplicar marcas rápidas.
- **Ordenar:** Ordena por hora de captura, hora de edición, calificación, tipo de archivo, tamaño o nombre.
- **Modos de vista:** Elige el nivel de zoom y los modos de vista: Vista única, Comparación o Referencia.
...
- **Preajustes recomendados:** Preajustes creados por Evoto para ayudarte a comenzar.
- **Preajustes del equipo:** Disponibles si tu cuenta está vinculada a una cuenta principal del equipo.
- **Mis preajustes:** Guarda, agrupa, importa y comparte tus preajustes personales.
- **Sincronizar:** Ubicado en la parte inferior de la sección derecha, los ajustes de sincronización se pueden aplicar a otras imágenes del mismo proyecto. Los valores compatibles incluyen:

![](https://support.evoto.ai/wp-content/uploads/2025/04/Screenshot-2025-07-08-at-21.03.58-300x54.png)

- Ajuste de color con IA
- Ajuste de color
- Ajuste de retrato
- Ajuste de fondo
...
- **Información básica:** Visualiza los detalles clave de EXIF e IPTC.
...
- **Vista previa:** Una vez creado un proyecto, aparecerán las vistas previas de las imágenes. Las marcas de agua son visibles solo en la vista previa, no en las exportaciones.
...
- **Importar con el botón +**: Otra forma de importar a un proyecto es haciendo clic en el botón + en la esquina superior izquierda del área de trabajo de la Biblioteca. Esta opción está disponible tanto en los espacios de trabajo de Biblioteca como de Edición, y se puede usar con o sin imágenes en el proyecto.

![](https://support.evoto.ai/wp-content/uploads/2025/04/Screenshot-2025-07-08-at-21.18.15-300x45.png)

- **Arrastrar y soltar**: Puedes arrastrar y soltar archivos de imagen directamente en un proyecto abierto.

> Nota : Al importar en un proyecto no vacío, puedes elegir agregarlo al proyecto actual o crear uno nuevo. Las importaciones de archivos LRCAT permitirán cancelar o crear un nuevo proyecto.
...
- En la lista de **Proyectos**, selecciona el grupo deseado.
- Haz clic en el botón **+**.
...
- **Crear proyecto**: Agrega un nuevo proyecto directamente bajo el grupo.
- **Renombrar**: Cambia el nombre del grupo.
- **Colapsar todos los grupos**: Colapsa todos los grupos de proyectos en la lista.
...
- **Importar carpetas** (no se admite la importación por lotes)
- **Crear subcarpetas** (solo cuando se selecciona una carpeta)
- **Mover / Renombrar carpetas** (no se permiten nombres duplicados)
...
Actualizar una carpeta sincroniza Evoto con cualquier cambio realizado fuera de la aplicación. Esto incluye:

- Actualizaciones de metadatos (calificación por estrellas, banderas, etiquetas de color, EXIF/IPTC)
- Nuevas fotos (importadas automáticamente usando **Carpeta de sincronización**)
- Fotos faltantes (eliminadas automáticamente)
...
Puedes crear una nueva colección usando el botón "+":

- Ve a la pestaña **Colección**.
- Haz clic en el botón "+" para crear una nueva colección.

**Agregar imágenes a una colección**

- **Método de arrastrar y soltar:** Arrastra imágenes desde un proyecto y suéltalas en una colección.
- **Incluir al crear:** Al crear una nueva colección, selecciona la opción para agregar las imágenes elegidas directamente.

![](https://support.evoto.ai/wp-content/uploads/2025/04/20250916221422-scaled.jpg)

**Ordenar colecciones**

Las colecciones se pueden ordenar usando el botón **Ordenar**. Elige entre los criterios disponibles, como nombre, fecha de creación o un orden personalizado, para mantener tu espacio de trabajo organizado.

**Editar y exportar desde colecciones**

Las fotos en las colecciones se comportan igual que las de los proyectos. Puedes:

- Aplicar ediciones utilizando toda la gama de herramientas de Evoto.
- Exportar imágenes directamente desde una colección con las mismas opciones disponibles en los proyectos.
...
- Presiona N o haz clic en “Vista de Encuesta” para comparar visualmente varias fotos en un diseño en mosaico (hasta 12 imágenes).
- Usa Cmd+Click (Mac) o Ctrl+Click (Windows) para agregar o eliminar imágenes.
- Haz clic en la X en la esquina inferior derecha de una imagen, o presiona / para eliminar una imagen.
- Siempre debe permanecer al menos una imagen seleccionada.
- Se pueden aplicar calificaciones con estrellas, etiquetas de color y marcas de selección/rechazo directamente al pasar el cursor sobre una imagen.

> Nota: El zoom está deshabilitado en el Modo Encuesta.

---

Color del Lienzo El color de fondo del lienzo se puede cambiar haciendo clic derecho en el Área Central y seleccionando el color. Esta opción está disponible en las vistas Lupa, Encuesta y Edición. La Vista en Rejilla utiliza el color de lienzo predeterminado y no se puede cambiar. ***Nota:*** El color del lienzo es solo para fines de visualización y no afectará la exportación.
...
Evoto ofrece varias maneras de etiquetar, seleccionar o calificar sus imágenes. A continuación se muestran las opciones con sus atajos de teclado correspondientes.
...
- Mover una o más imágenes a una nueva carpeta
...
- **Renombrar** (también cambia el nombre del archivo local)
- **Abrir ubicación del archivo**
- **Ir a la carpeta en la Biblioteca**
...
- Admite la creación por lotes a partir de múltiples imágenes seleccionadas.
...
- Los archivos sin conflicto se moverán; no se muestra alerta por los archivos omitidos
