...
source_url: "https://support.evoto.ai/es/plan-de-suscripcion/"
source_type: "post"
source_id: "10471"
language: "es"
...
- **Plan Inicial** – 800 créditos/año
- **Plan Básico** – 1.600 créditos/año
- **Plan Básico Plus** – 3.600 créditos/año
...
- Se puede acumular hasta **5 veces** el número de créditos del plan actual.
- Los créditos acumulados siguen siendo válidos mientras la suscripción esté activa.
...
- Disponible a un precio por crédito inferior al de los créditos de pago por uso (Pay-as-you-go)
...
Si se está en el **Plan** **Básico Plus** (3.600 créditos/año) y se solicita cambiar al **Plan** **Inicial** (800 créditos/año):

- El nuevo límite de acumulación será de **4.000 créditos** (800 × 5).
- Si se tienen **5.000 créditos**, se perderán **1.000 créditos**.
...
- Ir a **Mi cuenta → Facturación y uso**
- Hacer clic en **Cancelar suscripción** y seguir los pasos indicados

> Nota : La suscripción permanecerá activa hasta el final del periodo de facturación actual. Una vez finalizado, los créditos restantes caducarán y no podrán utilizarse. No se realizan reembolsos por cancelaciones anticipadas.
