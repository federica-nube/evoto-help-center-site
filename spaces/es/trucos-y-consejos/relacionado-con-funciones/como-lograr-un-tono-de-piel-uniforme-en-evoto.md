---
title: "Cómo lograr un tono de piel uniforme en Evoto"
source_url: "https://support.evoto.ai/es/como-lograr-un-tono-de-piel-uniforme-en-evoto/"
source_type: "post"
source_id: "11720"
language: "es"
...
- **Unificar Complexión Facial con IA:** Este control está diseñado específicamente para el rostro. Corrige los tonos de piel desiguales que pueden aparecer debido a la iluminación u otros factores, asegurando un color suave y consistente en la piel facial.
- **Unificar Complexión Corporal con IA:** Este control se enfoca en el cuerpo, excluyendo el rostro. Es particularmente útil para corregir tonos de piel desiguales en el cuerpo, como marcas de bronceado, para asegurar que la complexión del cuerpo sea consistente y coincida con el rostro.
- **Unificar Complexión Corporal:** Este control es la función de unificación original. Funciona tanto en el rostro como en el cuerpo para armonizar las diferencias de tono de piel entre ambas áreas. Es perfecto para situaciones donde el rostro y el cuerpo tienen diferentes complexiones debido a la iluminación o las sombras.
...
- **Usando la Máscara Local:** Selecciona el módulo de **Máscara Local**, luego elige el área específica que deseas ajustar: **piel facial**, **piel corporal** o **toda la piel**.
- **Ajustes de color:** Dentro de la Máscara Local, puedes aplicar ajustes básicos de color al área seleccionada para lograr un tono de piel más uniforme. Esto te da la flexibilidad de trabajar en una persona, múltiples personas o solo una parte específica del cuerpo.

Al combinar estos controles de IA con la precisión de los ajustes de Máscara Local, puedes asegurar que tus sujetos tengan un tono de piel natural y uniforme, mejorando la calidad general de tus fotos.
