---
title: "Relacionado con Edición"
source_url: "https://support.evoto.ai/es/relacionado-con-edicion/"
source_type: "post"
source_id: "10646"
language: "es"
...
- Accede al menú de Evoto en la esquina superior izquierda de la pantalla.
- Elige la opción **Preferencias**.
- Haz clic en la pestaña **Vista previa** en el cuadro de diálogo.
...
A partir de la versión **3.5.0**, hemos mejorado esta experiencia:

- Ahora se muestra más información útil y acciones para ayudar a los usuarios a **recuperar imágenes perdidas** utilizando datos en caché de su historial.
- Si hay vistas previas o miniaturas disponibles, se mostrarán para ayudarte a identificar rápidamente la imagen faltante.
...
- Localiza y **desactiva** la opción **Ajustes de color en tiempo real**.
- Así, el panel de ajustes de color mostrará todos los retoques previos.

![](https://support.evoto.ai/wp-content/uploads/2025/05/Snipaste_2025-08-01_16-13-08-300x282.jpg)

Aunque no hay un orden obligatorio, recomendamos hacer **primero los ajustes de color** y después los retoques básicos. Esto ayuda a evitar conflictos visuales entre efectos.

Tranquilo, **tus ediciones están guardadas**; solo es un ajuste de visualización.
