---
title: "Relacionado con Instalación"
source_url: "https://support.evoto.ai/es/preguntas-frecuentes-sobre-instalacion/"
source_type: "post"
source_id: "10679"
language: "es"
...
- En la pestaña **General**, haga clic en el candado e inicie sesión con una cuenta de administrador.
- Busque *“Permitir apps descargadas de:”* y seleccione **App Store y desarrolladores identificados**.
- También puede hacer clic en **Abrir de todos modos** para la aplicación que aparece listada.
...
- Vaya a **Configuración de protección contra virus y amenazas**.
- Bajo **Exclusiones**, haga clic en **Agregar o quitar exclusiones**.
- Seleccione **Agregar una exclusión** y elija el archivo, carpeta o proceso asociado a Evoto.
...
**Si la aplicación está en la lista:**

- Busca en la lista la aplicación que está siendo bloqueada.
- Selecciona la aplicación y haz clic en **Editar** en la parte inferior de la lista. Si la lista contiene muchas entradas, puede que tengas que desplazarte hacia abajo para ver el botón Editar.
- En **Acceso**, asegúrate de que esté seleccionada la opción **Entrante y saliente**, y cambia el tipo de acceso de **predeterminado** a **Abierto para todos los dispositivos**.
- **NOTA:** También puedes elegir **Usar puertos designados** si conoces los puertos que se deben configurar.
- Haz clic en **Guardar**.

**Si la aplicación no está en la lista:**

- Haz clic en **Añadir**.
- Haz clic en **Buscar** y localiza la aplicación Evoto para añadirla.
- Selecciona Evoto y haz clic en **Abrir**.
- En **Acceso**, asegúrate de que esté seleccionada la opción **Entrante y saliente**, y cambia el tipo de acceso de **predeterminado** a **Abierto para todos los dispositivos**.
- **NOTA:** También puedes elegir **Usar puertos designados** si conoces los puertos que se deben configurar.
- Haz clic en **Guardar**.

Una vez realizados estos cambios, podrás utilizar la aplicación que anteriormente estaba bloqueada.
...
- Excluya la carpeta completa o solo el archivo .exe.
- Confirme y vuelva a activar la protección en tiempo real.
...
- Haga clic en **Agregar**, seleccione la ruta de Evoto.exe o la carpeta que lo contiene.
- Confirme y restablezca la protección en tiempo real.
...
- Instale Evoto.
- Abra Avira → **Extras → Configuración → PC Protection → Scan → Exceptions**.
- Añada la excepción para Evoto.exe o la carpeta.
- Luego, en **Protección en tiempo real → Exceptions**, repita la excepción.
- Guarde y habilite de nuevo la protección en tiempo real.
...
3. Seleccione Evoto.exe o la carpeta correspondiente.
4. Confirme y reactive la protección en tiempo real.
...
3. Ubique Evoto.exe o su carpeta y agréguela como excepción.
4. Confirme y ejecute el programa.

Para instrucciones más detalladas, haga clic aquí: [Gestionar la lista de permitidos en Malwarebytes para Windows v4](https://help.malwarebytes.com/hc/en-us/articles/31589553442715-Manage-the-Allow-List-in-Malwarebytes-for-Windows-v4).
