---
title: "How to Save Time with Batch Style Matching: Sync & Presets in Evoto"
source_url: "https://support.evoto.ai/save-time-with-batch-style-matching-sync-presets-in-evoto/"
source_type: "post"
source_id: "12956"
language: "en"
...
- **Command + Click (Mac) / Ctrl + Click (Windows):** Select multiple individual photos.
- **Shift + Click:** Select a continuous range of photos.
- **Command + A (Mac) / Ctrl + A (Windows):** Select all photos in the project.

When selected, the photos will be highlighted in **white**.
...
This gives you full control if you only want certain edits copied over.
...
- Press **Command + C** (Mac) / **Ctrl + C** (Windows) to copy effects from the source photo.
- Then select the target photos and press **Command + V** (Mac) / **Ctrl + V** (Windows) to paste the effects.
...
1. Click the **Settings** button (gear icon) next to **Sync** in the bottom-right corner of the screen.
...
In the editing panel, click **Save Preset**.

![](https://support.evoto.ai/wp-content/uploads/2025/09/20250905115502-scaled.jpg)

A pop-up window will appear where you can choose which effects to include in the preset.
...
Open the presets panel and choose your saved preset.

![](https://support.evoto.ai/wp-content/uploads/2025/09/20250905121119-scaled.jpg)

The selected effects will be instantly applied.
