...
- **macOS 15.0 and above:** You need to enable **Files and Folders** permissions under **Privacy Settings**. ![](https://support.evoto.ai/wp-content/uploads/2025/10/1-300x259.jpg) ![](https://support.evoto.ai/wp-content/uploads/2025/10/2-300x259.jpg)
...
- **Windows:** Open **Device Manager** and check if the camera appears under **Portable Devices**. If visible, the physical connection is successful.
  - Some Sony cameras may install Sony control software and show **libusbk** in Device Manager. Uninstall this driver (check **Delete the driver software for this device**) and refresh Device Manager to see the camera correctly as a portable device. ![](https://support.evoto.ai/wp-content/uploads/2025/10/image-2-300x63.png)
