---
title: "Menu & Support"
source_url: "https://support.evoto.ai/menu-support/"
source_type: "post"
source_id: "21406"
language: "en"
translation_group: "7664"
primary_category: "uncategorized-en"
tags:
  - "mobile"
---

The **Menu & Support** section in Evoto Mobile provides access to your account information, app settings, and support resources. This guide covers all the features available in this section to help you manage your Evoto experience.
...
- **Email:** Sign in with your registered email address
- **Google:** Quick sign-in with your Google account
- **Apple:** Sign in with Apple ID (iOS only)
- **Kakao:** Sign in with Kakao account (available in Korea)
...
- Sample photos to practice editing
- Tips for importing and organizing photos
- Guide to applying AI-powered enhancements
- Instructions for exporting your edited images
...
4. Confirm by entering your email or verification code
5. Complete the final confirmation

**Important Notes:**

- Active subscribers must cancel their subscription before deleting their account
- All data including presets, usage history, and remaining credits will be permanently removed
...
- **Version Information:** Current app version and build number
- **Terms of Service:** Legal terms for using Evoto
...
- **Global:** YouTube, Instagram, Facebook, TikTok
- **Korea:** Naver Blog, KakaoTalk Channel
- **Japan:** X (Twitter)
- **China:** WeChat, Xiaohongshu, Bilibili, Douyin
...
- New version number
- Update highlights and new features
...
- **Bug Report:** Report crashes, errors, or unexpected behavior
...
- **Detailed Description:** Describe the issue or suggestion in detail
