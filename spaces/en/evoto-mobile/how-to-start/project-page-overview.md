...
source_url: "https://support.evoto.ai/project-page-overview/"
source_type: "post"
source_id: "21058"
language: "en"
translation_group: "7630"
primary_category: "how-to-start"
tags:
  - "mobile"
---

The **Project Page** in Evoto Mobile allows you to manage and organize all your photography projects. Access your existing projects, create new ones, and quickly navigate to your images for editing.
...
- **Photos:** Your device's photo library
- **Files:** Import from Files app or cloud storage
- **Tethered Shooting:** Direct capture from connected cameras
- **Sharing:** Import from other apps like Lightroom and Capture One
...
- **Cancel:** Tap "Cancel" to exit multi-selection mode

*Note: Your multi-selection state is remembered while navigating within the project. Exiting the app clears the selection cache.*
...
- Rate photos from 1-5 stars directly in the preview
- Filter projects to show only highly-rated images
- Quickly identify your best shots for editing priority
