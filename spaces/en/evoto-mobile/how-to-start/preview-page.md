---
title: "Preview Page"
source_url: "https://support.evoto.ai/preview-page/"
source_type: "post"
source_id: "21422"
language: "en"
translation_group: "7667"
primary_category: "uncategorized-en"
tags:
  - "mobile"
---

The **Preview Page** in Evoto Mobile is where you view and edit your photos. This guide covers all the features available on the Preview Page to help you navigate your editing workflow efficiently.
...
- **Zoom In:** Pinch outward to magnify details
- **Zoom Out:** Pinch inward to see the full image
- **Double-tap:** Quickly toggle between fit-to-screen and 100% zoom
...
- Show only photos with specific star ratings
- Quickly find your top-rated images
- Separate reviewed photos from unreviewed ones
...
- **Undo:** Step backward through your editing changes
- **Redo:** Restore changes you have undone
- **Multi-step:** Undo/redo multiple consecutive adjustments

This allows you to experiment freely without worrying about losing your work.
...
- Review your editing steps chronologically
- Jump back to any previous state with one tap
- Compare different editing stages
- Understand which adjustments were applied
...
1. Edit your reference photo
2. Select the photos you want to apply the same edits to
3. Use Sync to copy your adjustments
...
- **By Rating:** Highest to lowest or vice versa
...
- **Order:** Arrange photos in your preferred sequence
- **Select:** Tap to select individual photos
- **Multi-select:** Select multiple photos at once for batch operations
...
- **Before & After Button:** Tap to toggle between edited and original views
- **Long-press:** Press and hold anywhere on the screen to temporarily show the original image

This feature helps you evaluate your edits and ensure you achieve the desired results.
...
- **Contact Option:** Optionally provide your email for follow-up
...
- Edit one photo completely, then use **Sync** to apply settings to similar photos
- Regularly check **Before & After** to ensure natural-looking results
- Use **History** to experiment with different looks without losing progress
