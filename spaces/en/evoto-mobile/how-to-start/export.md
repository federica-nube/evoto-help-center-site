---
title: "Export"
source_url: "https://support.evoto.ai/export/"
source_type: "post"
source_id: "21005"
language: "en"
translation_group: "7624"
...
The
Export Settings
panel is the final step in your workflow, allowing you to control exactly how and where your edited photos are saved. This guide details every option available in the export interface.
# Export Overview & Status
...
Available when “JPG” is selected.
Control the compression level of your images to balance image fidelity with storage space.
Presets:
...
# Export Progress Experience

When exporting multiple images, Evoto provides an enhanced visual experience to keep you engaged during the process:
- **Image Carousel**: During export, a carousel displays all project images at fixed time intervals, providing visual feedback while processing.
- **Progress Indicator**: The export progress is clearly shown, letting you know how many images have been processed.
- **Result Display**: Upon completion, the final exported image is shown. If any exports fail, the failed image will be displayed as the cover.

This feature helps provide clear positive feedback during batch exports, making the wait more engaging.
# Finalizing Export
