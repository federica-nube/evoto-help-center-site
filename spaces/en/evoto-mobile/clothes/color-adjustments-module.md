---
title: "Color"
source_url: "https://support.evoto.ai/color-adjustments-module/"
source_type: "post"
source_id: "20787"
language: "en"
translation_group: "7575"
...
- **Camera Simulation:** Replicates the color characteristics of classic film cameras. Combined with AI White Balance and AI Exposure intelligent algorithms, Camera Simulation adaptively adjusts parameters for different photos, ensuring optimal results across various shooting scenarios. Includes 4 classic camera styles:
  - **Fuji NC:** Strong contrast with high color saturation and bright, magenta-biased skin tones. Best for outdoor scenes under daylight or flash lighting.
  - **Fuji NN:** Soft and gentle with an "amber-like" texture. Ideal for scenes requiring a delicate look.
  - **Ricoh +:** Vivid red tones with pronounced contrast for stronger visual impact. Well suited for street photography and night scenes.
  - **Kodak Ultramax 400:** Warm daylight feel with high saturation and prominent red and orange tones.
- **Gentle:** Soft, warm tones for a natural and delicate look.
- **Tone:** Balanced color adjustments for consistent skin tones and overall harmony.
- **Film:** Classic film-inspired aesthetics with nostalgic color grading.
- **Vibe:** Atmospheric and mood-driven styles for creative storytelling.
- **Trendy:** Modern, fashionable looks aligned with current photography trends.
- **B&W**: Classic black and white conversions with refined tonal contrast for timeless, elegant imagery.
