...
#### 使用 Evoto AI 演算法編輯的圖片可以商用嗎？

可以。Evoto 的 AI 功能並非生成式 AI，也就是說它不會創造全新的內容，而是只會修改現有圖片。因此，目前使用 Evoto 進行的編輯可安全用於商業用途。

---

#### 使用 Evoto 時如果有問題，我可以如何取得支援？
...
- 直接寄信到 support@evoto.ai，我們的技術支援團隊會儘快回覆。
